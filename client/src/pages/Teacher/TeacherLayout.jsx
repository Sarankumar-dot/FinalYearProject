...
const navLinks = [
  { to: "/teacher", label: "Dashboard", icon: <FaHome />, end: true, handSign: "🤙" },
  { to: "/teacher/upload", label: "Upload Lesson", icon: <FaUpload />, handSign: "👆" },
  { to: "/teacher/lessons", label: "My Lessons", icon: <FaBook />, handSign: "✌️" },
  ...
  return (
    <div className="layout-with-sidebar">
      ...
      <aside className="sidebar">
        ...
        <nav aria-label="Teacher navigation" style={{ flex: 1 }}>
          {navLinks.map((l) => (
            <NavLink
              key={l.to}
              to={l.to}
